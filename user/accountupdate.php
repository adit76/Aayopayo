	...
	<div class="container fluid">
		<div class="card-body">
		      ...
		      <div class="form-group">
		        ...
		        <div class="col-md-6  inputGroupContainer">
		          <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
		            <input  name="first_name" placeholder="Full Name" value="<?php echo $_SESSION['first_name']; ?>" class="form-control"  type="text">
		          </div>
		        </div>
		      </div>
          ...
          <div class="form-group">
            ...
            <div class="col-md-6  inputGroupContainer">
              <div class="input-group"> <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                <input  name="last_name" placeholder="Full Name" value="<?php echo $_SESSION['last_name']; ?>" class="form-control"  type="text">
              </div>
            </div>
          </div>
