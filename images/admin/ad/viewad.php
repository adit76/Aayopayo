<?php 
  ...
  $query = "select * from ads WHERE ad_status ='active' order by ad_id DESC ";
              ...
              <table class="table table-striped">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><a href="<?php echo $ROOT_URL1; ?>ad/updatead.php?ad_id=<?php echo $ad['ad_id']; ?>" class ="btn btn-info">Details</a></td>
