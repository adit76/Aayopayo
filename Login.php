<?php 
	...
	if(isset($_POST['login'])){
		...
		if($username !="" && $password !==""){
			...
			$sql = "SELECT * FROM users WHERE username ='$username'AND password='$password' AND user_role = 'user'";
...
<body>
  ...
  <div class="row">
      <div class="col-md-6 col-md-offset-3">
          	<form class="form-horizontal" action="login.php" method="post"  id="msform">
