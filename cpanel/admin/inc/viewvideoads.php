<?php
 ...
 include ('../inc/navigation.php');
  ...
  if(isset($_POST['submit'])){
    ...
    $target="../../../ads/".basename($_FILES['large']['name']);
    ...
    if($ad_name !='' && $ad_owner !='' && $ad_image !=''){
      ...
      $insert_ad = "INSERT INTO ads(ad_name, ad_owner, url, prize, ad_status, no_of_clicks, ad_start_date, ad_end_date) VALUES ('$ad_name','$ad_owner','$ad_image', '$prize','active',0, '$start_date', '$end_date')";
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php $_SERVER['PHP_SELF']; ?> ">
              ...
              <div class="form-group">
                <label class="control-label col-sm-3" for="image">Ad Video:</label>
                <div class="col-sm-9">
                  <input type="file" name="large" class="form-control">
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-sm-3" for="prize">Coins:</label>
                <div class="col-sm-9">
                  <input type="number" class="form-control" name="prize" placeholder="Enter number of coins to give">
                </div>
              </div>
              <div class="form-group">
