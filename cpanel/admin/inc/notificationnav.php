...
<li class="nav-item dropdown" style="margin-right: 50px;">
          ...
          <div class="dropdown-menu" aria-labelledby="alertsDropdown">
            ...
            <?php foreach($notifications as $notification) : ?>
              ...
              <a class="dropdown-item" href="/aayopayo/admin/product/addproductapproval.php?notification_id=<?php echo $notification['notification_id']; ?>">
        <?php   }else{ ?>
              <a class="dropdown-item" href="/aayopayo/admin/product/requestupdate.php?product_id=<?php echo $notification['product_id']; ?>">
        <?php    } ?>
                <span class="text">
            ...
            <a class="dropdown-item small" href="/aayopayo/admin/notification/notification.php">View all notifications</a>
          </div>
        </li>
</script>