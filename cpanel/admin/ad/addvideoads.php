<?php
 ...
 include ('../inc/navigation.php'); 
  ...
  if(isset($_POST['submit'])){
    ...
    $target="../../../images/advideos/".basename($_FILES['large']['name']);
    ...
    if($ad_name !='' && $ad_owner !='' && $ad_image !=''){
      ...
      $insert_ad = "INSERT INTO ads(ad_name, ad_owner, ad_type, url, ad_status, no_of_clicks, ad_start_date, ad_end_date) VALUES ('$ad_name','$ad_owner','video','$ad_image','active',0, '$start_date', '$end_date')";
...
/*      echo $insert_ad;*/
      ...
      if($query){
        ...
        if(move_uploaded_file($_FILES['large']['tmp_name'], $target)){
          header('location:viewvideoad.php');
          }
      }else{
    ...
    <div class="container-fluid">
        ...
        <div class="container">
            <form method="POST" class="form-horizontal" enctype="multipart/form-data" action="<?php $_SERVER['PHP_SELF']; ?> ">
              ...
              <div class="form-group">
                <label class="control-label col-sm-3" for="image">Ad Coin:</label>
                <div class="col-sm-9">
