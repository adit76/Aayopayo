<?php
 ...
 include ('../inc/navigation.php'); 
  ...
  if(isset($_POST['submit'])){
    ...
    $target="../../../images/adphotos/".basename($_FILES['large']['name']);
    ...
    if($ad_name !='' && $ad_owner !='' && $ad_image !=''){
      ...
      $insert_ad = "INSERT INTO ads(ad_name, ad_owner, ad_type, url, ad_status, no_of_clicks, ad_start_date, ad_end_date) VALUES ('$ad_name','$ad_owner','image','$ad_image','active',0, '$start_date', '$end_date')";
...
/*      echo $insert_ad;*/
      ...
      if($query){
        ...
        if(move_uploaded_file($_FILES['large']['tmp_name'], $target)){
          header('location:viewphotoad.php');
          }
      }else{
