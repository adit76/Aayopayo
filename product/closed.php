...
#$winner = 'SELECT * FROM PRODUCTS p INNER JOIN users u on u.user_id = p.winner where product_id = '.$product_id;

//Get result
$result= mysqli_query($conn, $query);
#$winners= mysqli_query($conn, $winner);

//Getch Data
$products = mysqli_fetch_assoc($result);
#$winnerrs = mysqli_fetch_assoc($winners);
